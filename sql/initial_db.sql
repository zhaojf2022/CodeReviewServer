...
insert into `t_comment_column`(`id`, `column_code`, `editable_in_add_page`, `editable_in_edit_page`,
                               `editable_in_confirm_page`, `excel_column_width`, `input_type`, `required`,
                               `show_in_add_page`, `show_in_edit_page`, `show_in_confirm_page`, `show_in_idea_table`,
                               `show_in_web_table`, `web_table_column_width`, `show_name`, `sort_index`,
                               `support_in_excel`, `system_initialization`, `dict_collection_code`)
values (10, 'identifier', '\0', '\0', '\0', 50, 'TEXT', '', '\0', '', '', '', '', 100, 'ID', 0, '', '', NULL),
       (11, 'filePath', '', '', '\0', 50, 'TEXT', '', '', '', '', '', '', 150, '文件路径', 100, '', '', NULL),
       (12, 'content', '', '', '\0', 50, 'TEXTAREA', '', '', '', '\0', '', '', 400, '代码片段', 300, '', '',
        NULL),
       (13, 'lineRange', '', '', '\0', 50, 'TEXT', '', '', '', '', '', '', 100, '代码行号', 200, '', '',
        NULL),
       (14, 'comment', '', '\0', '', 50, 'TEXTAREA', '', '', '\0', '', '', '', 300, '检视意见', 600, '', '',
        NULL),
       (15, 'type', '', '', '', 50, 'COMBO_BOX', '\0', '', '', '', '', '', 100, '意见类型', 400, '', '\0',
        'CommentType'),
       (16, 'projectId', '', '', '', 50, 'COMBO_BOX', '\0', '', '', '', '', '', 200, '项目信息', 1, '', '',
        'ProjectList'),
       (17, 'reviewDate', '\0', '\0', '\0', 50, 'TEXT', '', '\0', '\0', '', '', '', 110, '检视时间', 500, '', '',
        NULL),
       (18, 'realConfirmer', '\0', '\0', '\0', 50, 'COMBO_BOX', '', '\0', '\0', '\0', '', '', 100, '实际确认人员',
        900, '', '', 'UserList'),
       (19, 'confirmResult', '', '\0', '', 50, 'COMBO_BOX', '\0', '\0', '\0', '', '', '', 100, '确认结果', 1000,
        '', '', 'ConfirmResult'),
       (20, 'assignConfirmer', '', '', '\0', 50, 'COMBO_BOX', '\0', '', '', '\0', '', '', 100, '指定确认人员',
        700, '', '', 'UserList'),
       (22, 'reviewer', '\0', '', '\0', 50, 'COMBO_BOX', '', '\0', '', '', '', '', 100, '检视人员', 450, '', '',
        'UserList'),
       (23, 'confirmNotes', '\0', '\0', '', 50, 'TEXTAREA', '\0', '\0', '\0', '', '', '', 300, '确认说明', 1100,
        '', '\0', NULL),
       (24, 'confirmDate', '\0', '\0', '\0', 50, 'TEXT', '\0', '\0', '\0', '\0', '', '', 110, '确认时间', 1200, '',
        '\0', NULL);
...
insert into `t_department`(`id`, `name`, `parent_id`)
values (11, '研发中心', NULL),
       (12, '业务开发部', 11),
       (13, '基础开发部', 11),
       (14, '系统架构部', 11),
...
insert into `t_dict_collection`(`id`, `code`, `dict_desc`, `name`, `type`)
values (18, 'CommentType', '', '意见类型', 0),
...
insert into `t_dict_item`(`id`, `show_name`, `value`, `sort`, `collection_id`, `item_desc`)
values (12, '问题', '1', 0, 18, NULL),
       (13, '建议', '2', 10, 18, NULL),
       (14, '疑问', '3', 20, 18, NULL),
...
insert into `t_project`(`id`, `project_desc`, `project_name`, `department_id`)
values (12, '业务开发一组测试项目1', '业务开发一组测试项目1', 15),
...
insert into `t_role`(`id`, `role_desc`, `role_name`, `can_access_page`, `role_code`)
values (8, '系统管理员角色，拥有系统所有权限。', '系统管理员',
        'reviewcomments,mytodo,mycommitted,myconfirmed,all,servMgt,commentFields,enums,systemConfig,users,roles,depts,projs,reports,dashboard',
        'admin'),
       (9, '普通用户，有权限进行与自己有关的评审数据的处理，比如我的待办、我提交的、我确认的', '普通用户',
        'reviewcomments,mytodo,mycommitted,myconfirmed', 'normal');
...
insert into `t_user`(`id`, `account`, `name`, `password`, `phone_number`, `department_id`)
values (1, 'test', '测试用户', 'e10adc3949ba59abbe56e057f20f883e', '3333377', 15),
